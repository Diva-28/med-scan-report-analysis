...
from tumor_analyzer import reject
...
def analyze_tumor(file):
    ...
    # ----------------------------------  
    # MEDICAL IMAGE VALIDATION (FIXED)  
    # ----------------------------------  
    # Check if image looks grayscale (even if 3-channel)  
    ...
    # ----------------------------------  
    # EDGE CHECK (Tumor scan has structure)  
    # ----------------------------------  
    ...
    return {  
        ...
        "confidence": 0.94 if tumor_detected else 0.3,  
        "analysis_details": {  
